        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex flex-wrap gap-4 mb-6 text-sm">
                            <div class="flex items-center text-gray-600 dark:text-gray-300">
                                ...
                                Nhà phát hành: <span class="font-semibold ml-1 text-gray-900 dark:text-white">{{ $game->publisher }}</span>
                            </div>
                            <div class="flex items-center text-gray-600 dark:text-gray-300">
                                <i class="fa-solid fa-calendar-days mr-2 text-miku-500"></i>
                                Ngày đăng: <span class="font-semibold ml-1 text-gray-900 dark:text-white">{{ $game->created_at->format('d/m/Y') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            <h3 class="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-2 uppercase">Nền tảng hỗ trợ</h3>
                            <div class="flex gap-2">
                                @foreach($game->platforms as $platform)
                                    <span class="px-3 py-1 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm font-medium border border-gray-200 dark:border-gray-600">
                                        {{ $platform }}
                                    </span>
                                @endforeach
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <button class="flex-1 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-white font-bold py-3 px-6 rounded-xl text-center transition flex items-center justify-center gap-2">
                ...
                <div class="w-full space-y-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 relative h-64 flex items-center justify-center group cursor-pointer shadow-sm">
                        ...
                        <div class="relative z-10 text-center p-4">
                            ...
                            <p class="text-sm font-bold text-gray-600 dark:text-gray-300 mb-4">Hỗ trợ cài đặt & tìm bạn chơi cùng</p>
                        ...
                        <div class="space-y-4">
                            @foreach($relatedGames as $related)
                                <a href="{{ route('game.show', $related->id) }}" class="flex gap-4 group">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-bold text-gray-900 dark:text-white group-hover:text-miku-500 transition line-clamp-2">
                                            {{ $related->name }}
                                        </h4>
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            ...
                                            @else
                                                <span class="text-brand-500 font-bold">{{ number_format($related->price, 0, ',', '.') }}đ</span>
                                            @endif
                                        </div>
                                    </div>
                                </a>
