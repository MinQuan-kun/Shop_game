        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <form action="{{ route('admin.discounts.update', $discount->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="type" required
                            ...
                            <option value="percentage"
                                {{ old('type', $discount->type) == 'percentage' ? 'selected' : '' }}>Phần trăm (%)
                            </option>
                            <option value="fixed" {{ old('type', $discount->type) == 'fixed' ? 'selected' : '' }}>Cố
                                định
                                (VNĐ)</option>
                        </select>
                        @error('type')
                    ...
                    {{-- Is Active  --}}
                    <div <div x-data="{ switcherToggle: {{ old('is_active') ? 'true' : 'false' }} }">
                        <label
