...
<body
        ...
        <div @click.outside="activeModal = null"
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button class="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition text-left flex flex-col gap-2">
                        <i class="fa-solid fa-key text-2xl"></i>
                        <span class="font-bold text-sm">Lấy lại mật khẩu</span>
                    </button>
                    <button class="p-4 rounded-xl bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900/40 transition text-left flex flex-col gap-2">
                ...
                <div>
                    ...
                    <textarea class="w-full p-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-sm focus:ring-miku-500 dark:text-white"
                        rows="3" placeholder="Mô tả vấn đề của bạn..."></textarea>
                    <button class="mt-3 w-full py-2 bg-miku-500 hover:bg-miku-600 text-white font-bold rounded-lg transition">
                        Gửi yêu cầu
                    </button>
                </div>
            </div>
    ...
    <div x-show="activeModal === 'privacy'" x-transition.opacity
        ...
        <div @click.outside="activeModal = null"
            ...
            <div class="p-6 border-b border-gray-100 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 z-10 flex justify-between items-center">
            ...
            <div class="p-8 prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                <p><strong>1. Thu thập thông tin:</strong> Chúng tôi chỉ thu thập thông tin cần thiết (Email, Tên) để xử lý đơn hàng.</p>
                <p><strong>2. Bảo mật dữ liệu:</strong> Mọi thông tin thanh toán đều được mã hóa và xử lý qua cổng thanh toán đối tác (VNPAY/Momo), chúng tôi không lưu trữ thông tin thẻ.</p>
                <p><strong>3. Chia sẻ thông tin:</strong> Cam kết không bán hoặc chia sẻ thông tin cá nhân cho bên thứ 3 dưới mọi hình thức.</p>
                <p><strong>4. Cookie:</strong> Website sử dụng cookie để lưu trạng thái đăng nhập và giỏ hàng của bạn.</p>
            </div>
    ...
    <div x-show="activeModal === 'terms'" x-transition.opacity
        ...
        <div @click.outside="activeModal = null"
            ...
            <div class="p-8 prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                <p><strong>1. Quy định chung:</strong> Khi mua hàng tại Mirai Store, bạn đồng ý với các quy định về thanh toán và nhận game.</p>
                <p><strong>2. Hoàn tiền:</strong> Chỉ chấp nhận hoàn tiền trong vòng 24h nếu nhận game bị lỗi do hệ thống. Không hoàn tiền nếu bạn đổi ý hoặc máy không đủ cấu hình.</p>
                <p><strong>3. Hành vi cấm:</strong> Nghiêm cấm sử dụng tài khoản hack/cheat hoặc gian lận thanh toán.</p>
            </div>
            <div class="p-6 border-t border-gray-100 dark:border-gray-700 text-right">
                <button @click="activeModal = null"
